...
const SellerProfileFoodCard = ({ food }) => {
  ...
  let remainingTime = calculateTimeRemaining(food?.nowTime, food?.expiryDate);
    ...
    <div className="card kitchen-profile-food-card shadow-sm">
      <div className="card-body row g-0">
        <div className="col-8 pe-1">
          ...
          {food?.foodType == "PREORDER" && (
            <div className="text-muted food-active-time small mt-1">
        ...
        <div className="col-4 position-relative">
          <img
            ...
            alt="food"
          />
          <div onClick={() => handleAddToCart(food)} className="plus-icon">
            <Plus />
          </div>

...
const FoodPresentationWithSellerFlat = ({ data, index, width }) => {
    ...
    return (
        <div
            className='mb-4 col-xl-3 col-lg-6 col-md-6 col-sm-9  food-presentation-card border border-2 shadow-sm text-black rounded'
        ...
        >
            ...
            >
                ...
                <div className='text__file'>
                    ...
                    <div className='d-flex align-datas-center justify-content-center text-black'>
                        <Link to={`/ProductsDetails/${data?._id}`}>
                            ...
                            >
                                <h2 className="text-black">{data?.foodName}</h2>
                            </p>
                        </Link>
                    </div>
...
export default FoodPresentationWithSellerFlat;

...
const Category = () => {
  ...
  }, [newPostBody, params.id, foodAdditionalTags, foodTypeId, coordinate]);
      ...
      <section>
        <div className="container">
          <div className="filter-menu">
            ...
            <div className="d-lg-none">
              <Accordion defaultActiveKey="1">
                <Accordion.Item eventKey="0">
                  <Accordion.Header>
                    Filter
                    {/* {getTranslation("filter", currentLanguage, labelsTwo)} */}
                  </Accordion.Header>
                  <Accordion.Body>
                    <div className="asidebar bg-white shadow-lg p-3 rounded">
                      <button className="btn btn-primary w-100 mb-2">
                        {getTranslation("nearMee", currentLanguage, labelsTwo)}
                      </button>
                      <button
                      ...
                      >
                        {getTranslation("allCategory", currentLanguage, labelsTwo)}
                      </button>
                      <button
                        className="btn btn-secondary w-100 mb-2"
                        onClick={() => {
                      ...
                      >
                        {getTranslation("allSubCategory", currentLanguage, labelsTwo)}
                      </button>
                      <button
                        className="btn btn-secondary w-100 mb-2"
                        onClick={() => {
                      ...
                      >
                        {getTranslation("moreFilters", currentLanguage, labelsTwo)}
                      </button>
                    </div>
                  </Accordion.Body>
                </Accordion.Item>
            ...
            {/* Desktop View */}
            <div className="d-none d-lg-flex justify-content-center gap-2 mt-3">
              ...
              <button className="btn btn-primary" onClick={() => setTags(true)}>
                {getTranslation("tagss", currentLanguage, labelsTwo)}
              </button>
              <button
                className="btn btn-primary"
          ...
          {/* <div className="centerFilterBtn">
            <div className="filterBtn-group">
              ...
              <div className="filterBtn">
                <button className="me-2 myFilterBtn">
                  {getTranslation("nearMee", currentLanguage, labelsTwo)}
                </button>
              </div>
          ...
          <Row>
            <Col xs={12}>
              ...
              >
                <Modal.Header closeButton>
                  <Modal.Title id="example-modal-sizes-title-lg">
                    {getTranslation("category", currentLanguage, labelsTwo)}
                  </Modal.Title>
                </Modal.Header>
                <Modal.Body>
              ...
              >
                <Modal.Header closeButton>
                  <Modal.Title id="example-modal-sizes-title-lg">
                    {getTranslation("subCategory", currentLanguage, labelsTwo)}
                  </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                  <div className="dietary ">
                ...
                <Modal.Body>
                  <div className="dietary ">
                    {tagData?.map((item, index) => (
                      <button
                        className={`wrapper ${foodAdditionalTags.includes(item.tagName)
                          ? "bg-primary"
                          : ""
                          }`}
                        key={index}
                        ...
                        <div className="wrapperOne">
                          ...
                          <div className="dietary ">
                            {foodTypeData?.map((item, index) =>
                              item?.foodTypeName ? (
                                <button
                                  className={`wrapper ${foodTypeId === item._id ? "bg-primary" : ""
                                    }`}
                                  key={index}
                                  onClick={(e) => {
                  ...
                  {allFoodByCategoryList?.length !== undefined &&
                                ...
                                >
                                  ...
                                  <div className="text__file">
                                    ...
                                    {item?.sellerInfo &&
                                      ...
                                      >
                                        <div className="overlay__img">
                                          <img
                                            ...
                                            src={
                                              item?.sellerInfo[0]
                                                ?.sellerProfilePhoto[0]?.ex
                                                ?.imageUrl
                                                (() => {
                                                  const imageUrl =   item?.sellerInfo[0]
                                                  ?.sellerProfilePhoto[0]?.extraLarge
                                                  ?.imageUrl
                                      ...
                                      <Link
                                        to={`/SellerProfile/${item?.sellerInfo &&
                            ...
                            >
                              ...
                              >
                                ...
                                <div
                                  ...
                                  className="text-white d-flex justify-content-center"
                                >
                                  {`Order Before ${item.foodOrderBeforeTime}`}
                                </div>
                              </div>
                            </Col>
                          );
                    ...
                    <>
                      <div className="mt-4 d-flex justify-content-center">
                        {/* Bootstrap spinner to show a loading state */}
                        <div
                ...
                <div className="d-flex justify-content-center mt-3">
                  <VisibilitySensor onChange={loadMoreItem}>
                    {loader === true ? (
                      ...
                      // Bootstrap spinner for a more interactive experience

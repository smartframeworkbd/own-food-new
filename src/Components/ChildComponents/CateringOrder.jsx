        ...
        if (response.status === "Success") {
          await axios
            ...
            .then((res) => {
              Swal.fire({
                icon: "success",
                title: "Catering Food created successfully!!!",
              ...
              <div className="basic-form ">
                <form onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="row">
                    ...
                    <div className="form-group mb-3 row col-12 col-xl-6 col-lg-6 col-md-6">
                      <div className="mb-2">
                        <label>Event/Ocasion Name</label>
                      </div>
                      <div className="mb-2">
                        {/* <select
                          className="form-control input-default"
                        ...
                        <input
                          ...
                          id="reason"
                          type="text"
                          placeholder="Description of the event and ocasion name"
                          onChange={handleChange}
                        />
                      </div>
                    </div>
                  ...
                  <div className="Col-12 row gap-3">
                    ...
                    <div className="col-12 col-xl-6 col-lg-6 col-md-6 form-group mb-3 row">
                      <div className="col-12 mb-2">
                        <label>How many quantities (Minimum 11)</label>
                      </div>
                      <div className="col-12">
                        <input
                          type="number"
